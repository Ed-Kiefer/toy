...
(* OASIS_START *)
(* DO NOT EDIT (digest: 86a80d1af371ccb5dfd8375a54535ad1) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          bugreports = None;
          synopsis =
            "Toy program which changes behavior depending on an environment\nvariable value MERLIN_TRAVIS";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "toy.ml"});
               Test
                 ({
                     cs_name = "test_toy";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [ExternalTool "ocamlbuild"; InternalExecutable "toy"]
                   })
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\127\203\204Cy\002\204}u\025\225\022\r\138\007\188";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
